...
abstract class DynamicProductAttribute implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\DynamicProductAttributes\\Model\\Map\\DynamicProductAttributeTableMap';
    ...
    /**
     * Initializes internal state of DynamicProductAttributes\Model\Base\DynamicProductAttribute object.
     */
    ...
    /**
     * Compares this with another <code>DynamicProductAttribute</code> instance.  If
     * <code>obj</code> is an instance of <code>DynamicProductAttribute</code>, delegates to
     * <code>equals(DynamicProductAttribute)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return DynamicProductAttribute The current object, for fluid interface
     */
     ...
     * @return   \DynamicProductAttributes\Model\DynamicProductAttribute The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DynamicProductAttributeTableMap::ID] = true;
        }
    ...
    public function setCartItemId($v)
    {
        ...
        if ($this->cart_item_id !== $v) {
            $this->cart_item_id = $v;
            $this->modifiedColumns[DynamicProductAttributeTableMap::CART_ITEM_ID] = true;
        }
    ...
    public function setAttributeId($v)
    {
        ...
        if ($this->attribute_id !== $v) {
            $this->attribute_id = $v;
            $this->modifiedColumns[DynamicProductAttributeTableMap::ATTRIBUTE_ID] = true;
        }
    ...
    public function setAttributeValue($v)
    {
        ...
        if ($this->attribute_value !== $v) {
            ...
            $this->modifiedColumns[DynamicProductAttributeTableMap::ATTRIBUTE_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DynamicProductAttributeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DynamicProductAttributeTableMap::translateFieldName('CartItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cart_item_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DynamicProductAttributeTableMap::translateFieldName('AttributeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->attribute_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DynamicProductAttributeTableMap::translateFieldName('AttributeValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->attribute_value = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = DynamicProductAttributeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \DynamicProductAttributes\Model\DynamicProductAttribute object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDynamicProductAttributeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DynamicProductAttribute::setDeleted()
     * @see DynamicProductAttribute::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDynamicProductAttributeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DynamicProductAttributeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(DynamicProductAttributeTableMap::CART_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CART_ITEM_ID';
        }
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ATTRIBUTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ATTRIBUTE_ID';
        }
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ATTRIBUTE_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'ATTRIBUTE_VALUE';
        }

        $sql = sprintf(
            'INSERT INTO dynamic_product_attribute (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'ATTRIBUTE_VALUE':
                        $stmt->bindValue($identifier, $this->attribute_value, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = DynamicProductAttributeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DynamicProductAttribute'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DynamicProductAttribute'][$this->getPrimaryKey()] = true;
        $keys = DynamicProductAttributeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ID)) $criteria->add(DynamicProductAttributeTableMap::ID, $this->id);
        if ($this->isColumnModified(DynamicProductAttributeTableMap::CART_ITEM_ID)) $criteria->add(DynamicProductAttributeTableMap::CART_ITEM_ID, $this->cart_item_id);
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ATTRIBUTE_ID)) $criteria->add(DynamicProductAttributeTableMap::ATTRIBUTE_ID, $this->attribute_id);
        if ($this->isColumnModified(DynamicProductAttributeTableMap::ATTRIBUTE_VALUE)) $criteria->add(DynamicProductAttributeTableMap::ATTRIBUTE_VALUE, $this->attribute_value);
    ...
    {
        $criteria = new Criteria(DynamicProductAttributeTableMap::DATABASE_NAME);
        $criteria->add(DynamicProductAttributeTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DynamicProductAttributes\Model\DynamicProductAttribute (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAttributeValue($this->getAttributeValue());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DynamicProductAttributes\Model\DynamicProductAttribute Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCartItem(ChildCartItem $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDynamicProductAttribute($this);
        }
    ...
    public function getCartItem(ConnectionInterface $con = null)
    {
        if ($this->aCartItem === null && ($this->cart_item_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCartItem->addDynamicProductAttributes($this);
             */
        }
    ...
    public function getAttribute(ConnectionInterface $con = null)
    {
        if ($this->aAttribute === null && ($this->attribute_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttribute->addDynamicProductAttributes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DynamicProductAttributeTableMap::DEFAULT_STRING_FORMAT);
    }
